...
@section('content')
    ...
    <div class="card">
        <div class="card-header text-center">
            <h3>Biodata Monitoring And Controll</h3>
        </div>
    ...
    <div class="d-flex justify-content-around mt-4">
        @if (auth()->user()->level_id == 1 || auth()->user()->level_id == 3)
            <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#modal-create">Input Monitoring and
                Controll</a>
            <a href="{{ route('cetak.kartu.tindakan', $pendaftaran->id) }}" class="btn btn-success">Cetak Laporan Hasil
                Monitoring And Controll</a>
        @endif
    ...
    <div class="card mt-4">
        <div class="card-header text-center">
            <h3>RIWAYAT Monitoring And Controll</h3>
        </div>
        <div class="card-body">
            <table class="table table-bordered">
