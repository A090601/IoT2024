    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCreateLabel">Input Monitoring Controll</h5>
                ...
                <form method="POST" action="{{ route('tindakan.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('pendaftaran_id') is-invalid @enderror"
                            id="pendaftaran_id" name="pendaftaran_id"
                            value="{{ old('pendaftaran_id') ?? $pendaftaran->id }}" required readonly hidden />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="spesialisasi"
                            value="{{ $pendaftaran->dokter->spesialisasi }}" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('hasil_periksa') is-invalid @enderror" id="hasil_periksa" name="hasil_periksa"
                            required>{{ old('hasil_periksa') }}</textarea>
                        @error('hasil_periksa')
                            <span class="text-danger"> {{ $message }}</span>
                        @enderror
                    </div>
