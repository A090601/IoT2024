    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditLabel{{ $pendaftaran->id }}">Edit Device</h5>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('status_pasien') is-invalid @enderror" id="status_pasien"
                            ...
                            <option value="KARTU BEROBAT"
                                {{ old('status_pasien', $pendaftaran->status_pasien) == 'BPJS' ? 'selected' : '' }}>
                                BPJS
                            </option>
                            <option value="Umum"
                                {{ old('status_pasien', $pendaftaran->status_pasien) == 'Umum' ? 'selected' : '' }}>
                                Umum
                            </option>
                        </select>
                        @error('status_pasien')
